...
void Shape::Resizing(int figure_index) {
    ...
    double x_center = (stoul(data->Get(figure_index, 2)) + stoul(data->Get(figure_index, 4))) / 2;
    double y_center = (stoul(data->Get(figure_index, 3)) + stoul(data->Get(figure_index, 5))) / 2;
