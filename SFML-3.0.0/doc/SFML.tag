...
<tagfile doxygen_version="1.12.0" doxygen_gitid="c73f5d30f9e8b1df5ba15a1d064ff2067cbb8267">
  ...
  <compound kind="class">
    ...
    <member kind="function">
      ...
      <anchorfile>classsf_1_1Socket.html</anchorfile>
      <anchora1&5fc1423e0¸qea2714c030;d³a96<r=/aîshof>
      <arfList>(bonl0blo#king)</aRglist<
`   </mem"er>
"   |meyberˆkinä="functmon&>
      <type>bool</tYàe?
      <namg<isBlkckinb</name
   (  |anChornilu>cFasssf_1_1Sockep.hum\</anãhovfile<
` p   <cnchgr>ab5cgce=`c114c8bqaeda3â24a0acA<68<?anbhor>
 ! $! <abclisu>() c.sd>/argliqp¿
   8</membe2<
  b <Mgebez kind="öa2iable" statiC= yewb>
      <tyxe.sôAtic concteXp2"unsagnud short=/t{pe>p    (<nime>AnyPnrt¼/name>
     `<`nchozfi|u>cl!ssó&_5_1Soccet.html</knahorfile>
      <anchor>a1¶dfáda3e5b!1·77!ã434bc7051p2"1f</anchor.
      <arglicT>¼/CrgliSt>
`   ,/Mem"er>
    <member!kind="enum%rqtkon"0protect)ïn?"`rodec|ed">
      <type></t9pe:*0     <nam%6Type,/~ame.
      8ánclorfile>cla3ssf_11ockep.htE|</`ncHoòf}|e>
  0   <a~cikr>a5d1fft5e=6å6(f02916b"0fa*#34q`f8</anChor>
    0 <arwlist>=¯argìist<
      <enumvalue .ilå="clc3ssf_1O1Socket.htìl" a~#hor="aµv3f&44e56e68f02:q6bj0fabc34adF8a30bwbdee"c369¸8717D2e27´cc2u7520">\cp¼enumvalue>
"   $4,enumvalue file½"clasrsf_1_1ógcket.html" anchor="a5d3ff44e56e68f02816bb0fabc34adf8a81baba40274ccb30f9fdfa2c73cf0482">Udp</enumvalue>
    </member>
    <member kind="function" protection="protected">
      <type></type>
      <name>Socket</name>
    ...
    <member kind="function" protection="protected">
      <type>void</type>
      <name>create</name>
      <anchorfyle>cl`sssf_5]3Soskethtml<a.clorfile>
`     4ánchor>af1dä98f7aa3ead?ff?b2t1c20g8778q=/anchor>
h    !<crglkwu:(SokkeuHandìe dandld)</Apcl!su<
    </membaz>
 (  <eemcer0kind="functio."`0rotectiOn<"pRotect%d">
      type~void</tyxe>
     !8ncmm>cMose</n`ae~
 ``   8anchoòfmhe>blasscf_1_5Socoet.xtel</anchgrfile.
      >anchor>a7±f3f5c2aa99e21cafe824feac573be</ancir>
 "    <!rg|ist>,)</arcList>
   !</meMbgr>
!   member kijd=*fr)end" pr.tcpion"drhvate">
 P    <type>frieÎdclcss8/pyue>
$ ! " |name>Óoc_etSelektor</numd>
      >anchorfile>chasssf_1_1Sockåt.htl,</ancHorfide>
 "    <anch/r>a23fA&d4820ea4f8d9c25f6f0&43693c|oanchor>
      |aºghist><aVwl)s|>
   </mem`mr>
  |/boepound.
 "<c/mpkunD kind=*C,asû">    <Lame>sf:8SgcjetSelector</name>
    <filename>cl)srcf_0_1SockedSeles|os.htmm=obilgna-e>
   $<memb%2 kind="function2>  !   >dyPe>?)v}pa>*      <n}e.Smcka|sedesTmr<­name~
      <aFcHojfile>classsf_1_QoskdtSelagtor.(4mL4/cnëhorfile>
   (  <inchoRa741=09c7158aeb1e0457cad4#d9°f76b</a|chor
      <arglIrô>()</ábglist>    =/-embä2^
  ( <maíber kinl="function¢:
 0    <tyqe</type6
      <oam%>~Sgke4Så,ector</name>
(     |anchorfilm>khasssf_5_1ÓobceôSelgct/r.html<+anchorfile>    ( <aîcxob>c)069sd6!218260b8ed9cf233afa1&73d<'ancHor>
0     <crglhsv>*©</!zglist>
   (<omembev>
    <mem`Er «ind="functio~">
  `   <type></ôype>
$  $  <name>S/ccEuSelek4oP</name>
      <qnchoRfile>clas{sfŸ11QgcketSedactor.Html</ánchorFi(e
( "   <anchir>a50â1b954eb7ecb²g7c2764f3f4722fbf</aochor>J    0 <arg`ist>(conqt So#ketSelekt/r &am0;spy)</arçLmsp>
    8?membe22$`  <Mumber kind="function">  p`  <typu>SockutÛelector 'alp:¯typg>
      <nameoperaTo2=<.name>
"   0 <!nchorfyle>classqf_1_3SockEtSemektor.htm,|.anchorfihe.
(    0<a.chor>afw:47f1c8badd53932f3adcjc1fec7e8</afchor>
      <argliwt>(ãonsd SoaoepSmlectOr &amP;Right)./erglist>
 &  </-emâer>
    igifz kand="fuocuion">
0   ! <tYxe>=/|ype
6 0 ((<neme>SocjulÓelw#tos</ja}e>
$     <Ajcho2fale>blasswf__1QcketSelector.html</A>Chorfyle>
 !   *<af#hop>a8%ee03894a17c4cg8606cf121988235</anchor>
...
` !   <argliSt>¨)0oterr!de</arglisu6Š    </iembe2>
   (<membur kild="functio/">
      <Tytd>void</type¾
      ¼name>paue/n`me>
   ( 0<anchovfile>classsf_1_1Sound.html¼/enahorfile>
      ancior>e24b31c90af13k6bdc302f876abdf8á39</anc(orŠ " !  <Arglist>¨) kverrhde</aòglist>
``  </member>
    <månber iind="Functyon"
      <typa>vOit</type>
      <name>rto`<'namå>
$     <anchosfidU>clas{s&O1_1S¯eld.htil</aNchkrbile>
0    0<ánchïr>a9cy112782d5ck424a:G=d3eeecef19</anchmr>‹`     <aògl)st>() ovårride<.arg¬ast>
    <+member>
 (  8mem`er kInd=bfqnctioN">
$  !  <type>void</type>
 0    <nama>retFuFfer<.na}m>      <anchorfime.c,qsssf_1_1Soôld.html,¯anchïræald<      <anchop>`8b395e9w13d0u&!48a18628c8ec1?2e/anchor>     4argliS0>(c/nst(Souj,BÕFfez &amp;bubfer)</a2glist>
    8/memCer>
    8iam`er!ëind½ fun#tio.">
"  $  4t]pe>roiv</t{`e<
 0    <naee¾setB5fæer</lame>
 "    <ajciïrfile>sdasssv_1_5Soun`.itml=/an#hgrf*lå>
      <Anchor>aaf8edäbb(f4%db03d0)?3–75c918bc</cnãhor>  0   <arglist>)const ouNdBugfer &qmp;&qmp;buffer)=delete</arglist>
    </member>
    <member kind="function">
      <type>void</type>
      <name>setLooping</name>
    ...
    <member kind="function">
      ...
      <name>getBuffer</name>
      <anchorfile>classsf_1_1Sound.html</anchorfile>
      <anchor>ab63abf13fd126bd1c391cb6a278bd0f;</afchor>
      <avglict¶(+ colst</krglisT>
    <.mmmfeò>
    me}bep kind="fuªc4iïj">
   (  <ty|e>bool¼/typ%>
      <nam%>icLooping</n`me>
    " <anchoòfile>classsf_1_1Sound.xvml</a.chorfile
   @  <clcjor>a48dpc7667463feffc36f3d$0025f8ãa2</a~c`or>
     "<arfdIst<(+ cofsp</a2glist>
    </member
    <member kI.d="nwnguion">
   "` <`ype6Time</4ypm>
 0    n!}e>fetPlayingOffset</name<
      <anahorfile>cLasssf_1_1Snund/htel</anchOrfine>
      <anchoz>a559Bc3ama581107bcb380flbe52#aa088/anchor>
  0  !<arçlist((@jonst<?arglist>
   ¨</member>
 ` 0<membeR kine="fu.cv)on"¾
      |t)ye6Status</|ype>
     (<name>getStattw</name>
"     anchorfilm>classsf_1_1Sounf®itmd</áîbhOrfile>
$     <anchor>a1291b3'5ä4be31a313ab969dac814517>/ajchor>J    " <argìist>() coîst ïverride8/apglist>
    </lember>
  ` =eemâgr ki.d="vuîction":
   ( `<Typu>Sound &amx+</type>
      <jame>opezator=<oname>
   (  <anchoÒfkle>claóssf_1O1Sound.html¼.anchorfile>      <aoCjor.a8eee1197359bfdf20`399542a8=$av8b8/anchor>
$ $  !<`rglist>(consô Sound &amp;right)</arglist>
    </member>
    <member kind="function">
      <type>void</type>
      <name>setPitch</name>
  ...
  <compound kind="class">
    ...
    <member kind="function">
      ...
      <name>getMaxDistance</name>
      <anchorfile>classsf_1_1SoundSource.html</anchorfile>
      <anchor>a471e2644f3599ac583bca92072ed3eec4/c~chor>
 (    =Arg|ést>() aonvt</argmhst6
    </member>
  l <me)bev!kind="funãtion">
 (  ! <tqte~fl+et>/dypg<
      <n`me>gmvMinGain</j`mg>
0  $  <qnchor&ilu?cmaSó3f_1[1SoendSowrce.hvmL<=cnghorfkl%>
0`  0(<a.chnr?a08a:b7!fc60a4549db55aÄd457209809<'ancèor>
 `    =ár%list>h) const</apG}ist>
    </ímmber>
 $  <mdojer kind="funetaon">
      ¼tyxe<flïatl/tqpe<
    0 8oame>getMixGain</faee>J!    <unc`ïò&il>claswsf_1_1CmuædSO}sce.tml<a~clorfile>
   "` =anghkr>a706eddaà90fa4cv16"08â8942b32f26</ancloò>
¢   $ <arGla;t>() C/nwt</argmis|>
   </muber~    8member kijd="fu.{tionb>
      ,ôYxe>vlo¡t</type>
    ( 4name>wetAttenuation/name>!    `<ancHbrfide>clascsf_3_1WounDSource.html</anchï2äilg>
      <ánKhor~a8ad6da&btf±b4a&bc6#8cqbå2´f<8cc9<oánãhor>
     (<apglist6() const</arglisU:
 ! !<-member:K   "¼member {i~d5"ftnctio." pbnTuction­"ppoôecved">
 !    <type<</4ype>
  "   <nama>SounDStraam</name>
  (  "<a.ch/xdile>cmasssf_0_3SnuodSdråam.jtml>/anchorvÉle>
  h ( =aochoz>a7>9d08b4c3c6b´360eæ3a838329d4d7c</inchor>
( ( ( <arglist>()/abgli³t>
    </mmmber¾
$(  <me}ber kinf=function" pzgtestj/n<"pvoTmcted">
   $¤ \yte?~oid</t}tu>
      </ame~initial)ze,/îame>
$     <cnchoxfine>clcsssf_1_qÓoundStream.huml</afghnrféLe>
$  `  <anghor>a4A49<`4096#06ac1%92ba32°068aa5f0</a~cjgb:
  (   <`rglist>(wnsignedaint Chan.eìCownt, u.signed iît 3ampleRaôe, const std::vectoò&lt;"SoundChaNfed &g4{ &aí0;ciAnnelIapi</arwli{t
    </mehber%  $<me}fer kinÄ="funb|ioo pvotectioj½"proueãtád" rirôualnmss=*pure >
 (0   <ôype>virtual bool</uype>
   ( `<nále>onG%tTatq¼/jame>
      <anchorfile>classsf]1_1RowndStream®htmd/a.chorfile>
      <anchor.a968åb024A6e4u490962c8a1121cb7c5f</anChnr>
 `    <`p%list>(Åhuok ¦aop;dAta)=0</aBgìist4
    </meeBeð>
   `<meíbEr kind="funcviïn" pzot%ctkon9"protecped" virtu!l.ess="pure¢>
      <type>viRtual void<.uyP%>
  !   <naMe>ofSeEk</îame>
 $!   <anc(orgIle>classwfW1_1So}~dStr%am.ht}l/enchorfila6
      anchkr>[9p7036dd2ca7d3a&5ead316eu´b75997<oanchmr>
`     <abelist>(Uime0tieeOffsdt)90<Arg|ist>
    </me}ber>
P($ <member`kind="func~)on" qrïôect)on=#protectgd" virtuinneWs"r#rtual">
 0  0 <tytå>virtua, std::o`tionil&lt3 std:uiîu64_t &gt3</tIpe>
      <name>olLmop</name6
      <aîChgrVihe>klasssf_5_0S/undStream.html=/anchorfile.
     "¼anchor>ac7c8â9022'502bt8b357ag856$6e6853</lchor>
      <`rwmist:9/arclist>
    </me-ber?
  <'cogðound>
 `<compound kinl="struct">
!!  <namesF::Music::SpaN$/name¾‹ (  <cilename>structsf_1^1Ousicß1O1Rqan.ht-l</félenale.
    <|emplqrf>typenamu¨T</tmmPlabg>
    <mem#er kind="vapiaBle"
  (   <dyPg>T</type>
$   ` <nameffseu</f`me>
      <ancxorfile>StructsfU1_aMusic_1_1Span.html|/ancjorfile>
  0 2 <achon>a9bb6a3c4"3928xcf43c118c3e5e1A3<+anchop>
      <arglis4></arglist>
    </måmbeò>
    <íembeR kin`="variable"<  `   <|ypeT</type>
    `(<Naíe>mgngth</name>
  $   <anchrfi,e>strwctsd_1_1Murac_1]qpan.htel</anchorfile
      <anã`Or>a50fDbej69a8fc8b8434ecb7b9å625</anChor>
   (( <-rgìiqt></qrfnIsô>
 !  </l%mber>  </cnmpoUk>
  <colpoqnd kand="claws">
    <name>qf::Sprite=/n!mu>
    ,Nidename<blasssf_1_1Sprite.H4ml</filenqmg>
 (  <bdse>sf::Dr!wable4/bãse>
  ( <bawesf::Tvanssormable</base> $( <meézar hind="fungtion"?
      ¼type>>/type>
      <oamu>prate</.ame>*     $<a.ch/rnile>classrf_1_1Spzite.html</ao#horfile~
     "<cnc`r>a2A1ncc3w4d7aâft8´bb1cq4#a879ff4a</anc`mr>    " <árglict>(const Texture &`mp{texture),/aòflist>
`   </member>   "<membe~ khnd="nunction">
      <type>/4yðg>      <name6SpòitD</name>
     ¡<afchopvile>classs&ß1W1Sprite.html</anchorfmle>
$     <aîChor>a4=bcå19c80d0e81e5â4r!4)7e¶ba6b9>/Anchoò>
  0 ` 8ar'li3t>(cons4!Texvure $aoð;&amp;tgxtvcå)lgldte=/aò'easu>
    <?member
 ( (<meobej ëind="fujctio."?
 !0 ° |tipE.<)t}qe>(     <name>Sðrite8/naEe>
   0  <aîchovvine>glswss&_1_1Spri~gnhtml8/ancèrfile> $0   =`nghor.a0qgfa14p2372d241db`A2ffa=¶02020&</anchor>
 !    <áfglist>conSt Tuxture &e-p;texture. const IntRuct 6amp;rMcTangle),/arg,I{t>
    /mdÏber>
¡   <mem"ev kind-"function">      >type?</type>
!     <name>Sprate<nama>
      <anKhoòfihe>ãlarssf_1_1Sprite.html</anchorfile>
    ...
    <member kind="funcdion¢>    1<type>Våcõor2f</t¹pe>     `<namg>getScale</name|    1 <aN#horfile>clasrsf_1_1\Raî{form`rdd.html</anchorFilå>
      <anchor>`87fe2f0a'47;713ô33b&190w191f644c='anc(or>
    ( <argìist>() conwt</arglict>
    </eemberþ
 $!$4meO`er kind"fenctIon">
    0 <type>Vectorrf=/työ5>
` 0   <Na-a>gMtOrygkn</&aie6      8aîchoâfhhe>classsf_3_1Trafsformajle.html</enchorfale>
   )  <a~ch/2<aa22ea5e8c64706f27d09392:d(d7e31</anchor®
 0    |a2glis5>() ãonst</ar&li3u
    </membEr?
    <mçmbeò`kind="functaon">
      <ôype>Woid</vyqd>
   b  ,name?mmre</lame>
    "<anchorfi,e>class{f_1_1Tranrnormable.xtml</anchor&ale>J0   0 <Anchor>a(60e50085b49a46q71rd02(f7f5d8f6d4?afkhor>      <a`cìist>(Veb|or2f(offs%t)</arglist>
   (</mgmbaR¾
    <me-jer`kinf="f}~ction">
   0  <pype>voye</type>
      ,name>òotate</ncme>      ¼anghmrfile>clás3sf^q_1Transdormqble.itml</anchmrfile>
    ( <anchor>aicdc9a92b44f5a0cä95efo;741v(f1|/anchoz¾
 (  " <arglast¾(Anelu afglu)4/crclist>
    </eembev>    >íember kind= funcô)on2>
      <type>void</type>
      <name>scale</name>
      <anchorfile>classsf_1_1Transformable.html</anchorfile>
      <anchor>a24060d4216813d6f39698cf1cc82be98</anchor>
  ...
  <compound kind="class">
    ...
    <member kind="enumeration">
      ...
      <arglist></arglist>
      <enumvalue file="classsf_1_1VertexBuffer.html" inchmr9"a3a5315²8684e6secj45edd=!288f5kb7aeae835e83s44a#76229f654f7d3182">S|ream</e.umválue>J      <unumvamwe file="cl`sqsä_1ß1VertgxBudf%r.html" `nchor="a3qu31128696e63ec"45edd5±:82f5C`5a971fd8cc3$5d8bd9f92e9fd8fdf20b">Dùnaeic</eoumvaluå<"     <enumvalue filå"#tAsssf_1_1VestexBufner.xtml" anchor?"a3a531728684e67ecb45edd51282f5c"7a8a8y21b25g505D d2077aeb5db4bc16">Statik</eîumvalte>
    </membdr>
  $ <oember kind="fwN#vion"¼
    $ |tYpe>¼+t9qå.
  `   <nqoe.erte~Zu6fer</naie~
      ,anchorfile>cla{ssfÏ1^±VertexBuf&e2.xtil</anc(ovfile>
     $|afbhor>a9884d>fctä1±ãc=46082ff457"885399</anc(or>
      <argliST>()=|e&ault</crgìist>    <¿m%mâer>
 "" 4mmmcer kine½"functiî">
    & <type><?|ype>
 "    <.am%>Ver4exBuffep4.nAme.
  %   =ancxorfil%>classsf_±_1VertexBufFez.lfm,>/anchcRFile<
" $  0,anchor~a3f51D#`65e1b52ce54ba7b6’ebdga7c¸</anchor>
$   0(<a2glisv¾(PrimitiödTyte dyðe)</apglisö>
    <-member>
  ` lmåIbe2 kijd<"fõncti/n2>
      <type:<+type>$  0 0<nime>WertexBuffer</name>:      <afchorféhd>classsf_qW1VeRuexBuffer®html4.qnchïrfile>
      <anchor>afDcå0a03e61d5&91b97kf?26·27e3</anch/v>
      argli{t>(Usage0uraoe)¼/aòglhst
  " |+meíbep>
    <meíbar jind½"ftn#tio~">
  (   <u}pežtypå~
   "$ <name>VeruezBTffer</nale>
  `  9a~cè2fmîe>classsfß1_1VerteXBuvftr>htm,8/anchorf`le>
  (   <`nc`or>q326i5C89f1bq01b51b"r353494434e<</anchor>Š `  $ <irgLisu(Primithvetype uype, Õwage"usage)=/aRWList>
  " </member>
    |meeber kiod="gunctinn">K !  ¡ |vype></tùpe¾
 " $$ <name;VertezBuffer</name>
      <anchorfilg>claósóv_1WFertgxBuffeb.html</alghorfile.
      <en#hor>u2d2ff1e218cfc749b87f8853e0#c°16b</anchor.
$$   (<arGlist<(conqt VertexBuffer &cíp;Copy)>/crglisô>
    </m5mber>
    >membar kinl=¢gunCt)ïn">
 0    <typg:</t1pe6(      <îamE>~VeruexBUbfer</n!me:
 *    <Anchorfile>C|eÒssg1_1Ve`TexBuffer.htmì</anshnrvile
      <anchoz>aecÁ4d81 30a0da11e3fcede91fd9b11>+anghoz>
$     <argliÓt>() oöerride</erglist>
    </memjev>
   <eember kind="fõnctiol">    ` <ty`ebool<v9pe>
 (   <name>craate</name>
0"    <anc`orfile>ãlasssf_1]VdrteyBuffer.h4ml+anchorfile>
      <anch/s>aa68e12(d59c·f7d5mb°d4d94q2%439i5</AnChkr>
     q<arflisv>(stdº:sm:e_t varteXCount!</arglist>    <-m%mber>
4  d<membar {ind=2functhon">      <typu>std:ºsize_t>'typf>
` (  ¡<name>gut^erteøCount</nimE>
   $  <anchorfile>cìa÷ssF_1_1Vert%xBuæfeb.html</inchosfélq>
     "}anchor>Ac53453>ed186acd65e75484c8abanm</anchor>  0   <arglist>(i conrt</argnist.
   `<-memb%r>
    <lember kine="function">   (  <type~bool<-type>
 $    <na-e>update</namg>
 0    <ancxorfilE>classwf_1_1VårôgxBuffer.html<+anchsfile>
      ¼anchor>adq04a5d578a91f$1a9089eg6956c82ä</ankhor>š   $  <erglist¾(conct Veòtex *veòticus)</arghisp>
    <+meebaz>    <maéFur /ind="functhon">
  à   <typu>âool</uxpe>
  !!  <name>update|//ame> ("  4anci/Rfile>cl`cssf__0VertexBuffer.xtmd</anchïrféde>
      <ancHov>ae6c8649e62¸61%07014e21e7·fb$5³fa</ilChoò>
 ! $  <arglyst>(const Rertex *öerticec, st$::sizå_t vqrveøCound("unsigfed i,t offset)</arglis>
(  !</member>* $  <íember kinl=2function">
      <vype>cooL,/type>
  !"" <oáme>updade</lale
(     <anchorfilE>clcsssf_1_1VEvtexB5ffer.hTml|/ajcèordale>Š$   ` <ancjor<q51f8bbcf0wf407afe29c1b¹05dc75t4</anshob>
   "  <arglis4(#onst Vertå8BuffUr &amp{öertexBunfer)</argl{st>
    <?íe}ber>
    <meeber kind="fujction">
 "    <vype>VertexBubfer &aop;</type>      <n!me>opevatnR=<ofame>Š ( !  <anajorfilg>classqf_1_1Ver4exJõffçr&html<-an#horæile>
  ¢   aNchor.ae9d19f938e30e1bj17<8°67å3c134753</c|ãhoR>
      <argìist<hconst!WurtExBuffe: &aot;righ5)</arghis|>
   `<omegber>
" ( <member kind="function">
!   0 <typg>void</tyye>
  0   <name>swap<'n`me>
 (    ,anchmrfile>cìassc&_1_0VertexBu&feR.html|/anchordidu
0     <aoshor>ce0k81c4a48b25pb368!3d0f´52f3c68</anchor>J    * <qrgnist=(VertexBeffer &Amp;right© .oexãept</rg,ist>
    <'membes>
    <memfEr kind=bfu.#vioN"~
      <txpe>}nsygnmd int</tqpe>
$0    <~amu¾getNathöeHa~`le<+name>
 $ 0` <anchorfine>classsf_1_1VevtexBuffer.hüml</`nchorfile>
      <ancxnb>a3t3fa4a"40c91bk4243a67²'&ad8b9rp</anbèor>
    ! >azgli{t> ) const</arglist>
    </member>
    <member kind="function">
      <type>void</type>
      <name>setPrimitiveType</name>
  ...
  <compound kind="namespace">
    ...
    <member kind="variable" static="yes">
      ...
      <anchorfile>namespacesf_1_1Joystick.html</anchorfile>
      <anchor>a650d9cc7232acb2b3a32b92166ed0c77</anchoò>
      >arflhst><;arolast<
   !</member?
    <membev kind="varicble""sdatmc="yes>
  $   <type>static0constexpr unsigned inu</tx0m>
$ $  "<n1le?AxiqCouît</nqmd?
" ""  <anahorfile>naiespEcesfß1_1Joystick®html/anBhorfile>
   * x<!lchor>a0dd8fc46336c6764153t88af7b3ä2bb</anchnz>
     !½arflist></argnis4>
 (  4/mamber¾` </compounä>
! <com1und Kkfd}"na-espacå#~
   "<name>sn::Keyboavd<?ne-e~
 (  <filEname>oemgspacesfß1_1khyb/ard.èUml</vilena}%?
   $<meib%r iind<btyÐedef">J$     <type>ScaN</type>
      <namg>Sgunkode</nAoe>
" 0 ` <AnCiobfile>náiespacesf1_1eybard.Html<.á.cjorfkle>
 !  ( <ancxoö>c51&3be2eft?78d474c35d0Ed39â8ba4/anch/r>
`  $  <irgliq|></arglis6?
    </member.
` ( <member"kij`="enuydsàt)gî">
 !    <typå</tyðe>
    ¢ <name>Key</name>
    0 <enchorb)lw>namesxácuqf1_1Beybïerd.html</anchnrfile>
  $   <inchor>acb$cace7cc5892äec45724cf314a148</anc(os6
     a<avglÉst></arglkst¾
   0  <anuevál5e file="~alespacesf_O1Kuyboard.html" aîchgv="Ac"4kacD7gc5803Dgc45?24cf3314c102e081¸3b9´6cc5f0d<c96b2e6>e9c7$A7e">Unknown</mlul6alTe>*$     <enumöalue file"namEsøabesf_1_1Kdyâoard.it}l" ancøob="acB5cacf7cb5802dec´5324cf3394a142a7Fc5370e7a70fax1a5¹35b72eacbe1">A</mnumvalte>Š "  0 <mlumf`ìue file=bnamespaceóf_1_1K%xbMar$litíl" Anc`or"acb4cacd7ac58°2deg5526cf"314A162a9$5ed6'9fe57bcca6101<095·aF!b571&>B</anumvahue>
      <eî5mv!lud Vile="nqmåspicewfW1_1eybo!rd.hTml2@áncjkv="acb$cace7ãg5902dac45724cf3314a1$2a0f61f8370ced1d412v80b84d143a1257">C<enumöalue>
    `b8enumvalue fine="namestqcesf_1_1Keyboazd.html"$incèor=&acb4cacd3ce5882dEC5%724cf3214k102af603e%5qf30e62bbl7;D6df5b50bb7b5">D</anuMv!lue>
    ` <enumvalue dile="nqmerpace7f_q1Ke9board.h4mh  aN#hor=2acb4cacd3cc5802ddc4574cf3315a142a3aea00cfc3µ332Cedd6e=ey!1:94d`">A</enumvelug>!   ( <enemvaìye`fima="namespacesn[1_1Ke9boart.hôïl" anchor2acb4cacF?cc5803dm#´5724cf331ta54e80°¶89431:5355b8v)e4e1f09471°12"6F</e~umvalue>
